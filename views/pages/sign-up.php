...
<div class="lg:w-8/12 rounded-2xl m-auto bg-purple-200 py-10">
    <h1 class="text-4xl text-center font-bold py-5 text-purple-800">Account aanmaken pagina</h1>
    <form action="<?php $_SERVER["PHP_SELF"]?>" method="POST" class="w-6/12 m-auto">
        <label class="text-2xl text-blue-800">User name</label>
        <input class="w-full px-3 text-white bg-blue-800 rounded-xl my-5 py-3" name="username" type="text">
        ...
        <label class="text-2xl text-blue-800">First name</label>
        <input class="w-full px-3 text-white bg-blue-800 rounded-xl my-5 py-3" name="firstname" type="text">
        <label class="text-2xl text-blue-800">Last name</label>
        <input class="w-full px-3 text-white bg-blue-800 rounded-xl my-5 py-3" name="lastname" type="text">
