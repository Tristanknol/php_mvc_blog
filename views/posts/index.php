<div class="container px-20">
    ...
    foreach ($posts as $post) {
        ...
        if (isset($_SESSION["loggedIn"]) && $_SESSION["loggedIn"] === TRUE){echo "<td><a class='text-xl text-purple-900 underline' href='?controller=posts&action=crud&ID=" . $post->ID . "'>Edit</a></td>";}
